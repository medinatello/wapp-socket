# Go Prompts - TemplateGo

Este archivo contiene prompts estáticos reutilizables para trabajar con agentes de IA en el proyecto TemplateGo. Cada prompt está diseñado para ser eficiente y seguir los estándares de desarrollo definidos en `Cases/Documentation Main/`.
